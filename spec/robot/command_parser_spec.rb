...
module RobotSimulator
  describe CommandParser do
    ...
    let!(:unfiltered_input) {[["PLACE 3,0,NORTH"], ["MOVE"], ["LEFT"], ["REPORT"], ["RIGHT"], [], ["000"],
        ["111"], ["1 0 a b"], ["PLACE 3,3,SOUTH"], ["LEFT///"], ["MOVE"], ["MOVE"], [], ["REPORT"], ["dkfjlskdjflksf"],
        ["123123123"], ["MOVE 234234234"], ["RIGHT"], ["khkhkh"], ["~~~~~~~~~~~~@@\#$%&T^*&^*^*&^&*"], ["REPORT"]]}
    let!(:filtered_list) {[["PLACE", "3", "0", "NORTH"], ["MOVE"], ["LEFT"], ["REPORT"], ["RIGHT"],
         ["PLACE", "3", "3", "SOUTH"], ["MOVE"], ["MOVE"], ["REPORT"], ["RIGHT"], ["REPORT"]]}
